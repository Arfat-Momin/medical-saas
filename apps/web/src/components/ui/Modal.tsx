  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-4 py-3 md:px-5 md:py-4">
        ...
        {footer && (
          <div className="flex flex-wrap justify-end gap-2 border-t border-slate-100 bg-slate-50/60 px-4 py-3 safe-b md:px-5">
            {footer}
          </div>
        )}
      </div>
