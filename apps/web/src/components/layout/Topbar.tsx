...
export function Topbar({ onOpenMenu }: Props) {
  ...
  return (
    <>
      <header className="glass-strong ios-enter d-1 flex min-h-[60px] shrink-0 flex-wrap items-center justify-between gap-2 rounded-2xl px-3 py-2 md:gap-3 md:px-4">
